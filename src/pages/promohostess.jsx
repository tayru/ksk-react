	...
	<main className="page14">
		<div className="page__main-block main-block">
			<div className="main-block__container _container">
				<h1 className="staff-helper__title animate__animated animate__fadeInRight">Промо-хостес</h1>
				<div className="divider">
					<img src="/static/img/divider-white.svg" alt=""/>
				</div>
			</div>
			<div className="main-block__image _ibg">
				<img src="/static/img/promohostess-cover.jpg" alt="cover"/>
			</div>
		</div>
			...
			<div className="row">
				...
				<Slider {...settings}>
							<div class="slider-portfolio__item">
								<img src="/static/img/promohostess1.jpg" alt=""/>
							</div>
							<div class="slider-portfolio__item">
								<img src="/static/img/promohostess2.jpg" alt=""/>
							</div>
							<div class="slider-portfolio__item">
								<img src="/static/img/promohostess3.jpg" alt=""/>
							</div>
							<div class="slider-portfolio__item">
								<img src="/static/img/promohostess4.jpg" alt=""/>
							</div>
							<div class="slider-portfolio__item">
								<img src="/static/img/promohostess5.jpg" alt=""/>
							</div>
							<div class="slider-portfolio__item">
								<img src="/static/img/promohostess6.jpg" alt=""/>
							</div>
							</Slider>
				</div>
			</div>
